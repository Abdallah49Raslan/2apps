...
import 'dart:async';
import 'package:application_1/Abdallah/Security/user_detect.dart';
      ...
      _firestore.collection('drivers').get().then((snapshot) {
        for (var doc in snapshot.docs) {
          ...
          if (fingerprint == name) {
            ...
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => const UserDetect()),
            );
          }
        }
      });
                      ...
                      child: ClipRRect(
                        ...
                        child: Stack(
                          ...
                          children: [
                            ...
                            if (urlPic == null) const Icon(Icons.person, size: 60),
                          ],
                        ),
                      ),
                    ),
