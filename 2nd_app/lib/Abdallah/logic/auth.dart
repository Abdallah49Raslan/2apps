...
import '../started_pages/Owner/entry_Owner.dart';
    ...
    if (user != null) {
      ...
      if (documentSnapshot != null && documentSnapshot.exists) {
        ...
        if (userRole == 'Owner') {
          ...
          print('4');
          // If role is not recognized, show an error message and return to LoginPage
        ...
        print('5');
        // If user document does not exist, show an error message and return to LoginPage
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Row(
              children: [
